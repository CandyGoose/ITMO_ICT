...
print('Содержание таблицы users:')
for user in users:
    print(user)

'''JOIN
сложные запросы, включающие операции типа JOIN для извлечения данных из двух связанных таблиц.
...
print('Содержание users_posts:')
for users_post in users_posts:
    print(users_post)

'''выполним SELECT-запрос, который возвращает текст поста и общее количество лайков, им полученных:'''
select_post_likes = """
SELECT
  description as Post,
